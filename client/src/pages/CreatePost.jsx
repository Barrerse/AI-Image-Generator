    ...
    return (
        <section className="max-w-7xl mx-auto">
            <div>
                ...
                <p className="mt-2 text-[#606e77] text-[16px] max-w[500px]">Create imaginative and visually stunning images generated by DALL-E AI and share them with the community</p>
            </div>
